...
路径均相对于 `skills/spec-index/`，使用 `../specs/` 前缀。

## 完整章节列表

01-技术栈与基础、02-应用配置与开发环境、03-项目页面结构、04-路由与导航、05-页面布局、06-搜索区、07-表格、08-表单、09-弹窗、10-通用业务组件、11-接口与数据层、12-详情展示、13-云组件、14-环境变量、15-构建与部署、16-按钮权限、17-接口动态文本、18-GitLab、19-底座平台API、20-jjb-cmd、21-jjb-common-lib、22-AI执行约束。

各章节详细路径见主 SKILL 或直接浏览 `../specs/` 目录。
...
| parseJSON, tools.router, dayjs, http, qs, crypto | `../specs/21-jjb-common-lib/`、`../specs/01-技术栈/` |

更多关键词请直接搜索 `../specs/` 下对应章节。
